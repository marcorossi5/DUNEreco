...
PARSER.add_argument("--model", "-m", default="CNN", type=str, help="either CNN or GCNN")
PARSER.add_argument(
    "--device",
    "-d",
    default="0",
...
PARSER.add_argument(
    "--loss_fn", "-l", default="ssim_l2", type=str, help="mse, ssim, ssim_l1, ssim_l2"
)
PARSER.add_argument("--out_name", default=None, type=str, help="Output directory")
PARSER.add_argument("--warmup", default="dn", type=str, help="roi / dn")
PARSER.add_argument(
    "--load_path", default=None, type=str, help="torch .dat file to load the model"
)
PARSER.add_argument(
    "--threshold", "-t", default=3, type=float, help="Cut threshold on labels"
)
...
def inference(args, model, channel):
    ...
    metrics, res, t = test_epoch(
        args, None, test_data, model, ana=True, warmup=args.warmup, labels=labels
    )
