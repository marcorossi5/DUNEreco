...
def main():
    ...
    legend_elements = [Line2D([0], [0], marker='o', color='white', label='No hit',
                          markerfacecolor='white', markeredgecolor='black', markersize=7),
                       Line2D([0], [0], marker='o', color='white', label='Hit',
                          markerfacecolor='blue', markeredgecolor='black', markersize=7),]
    ...
    plt.savefig('denoising/benchmarks/plots/roi_crop_sample_target.pdf',
    ...
    plt.savefig('denoising/benchmarks/plots/dn_crop_sample_target.pdf',
                bbox_inches='tight', dpi=200)
    plt.close()
    ...
    fig.colorbar(z, ax=ax, shrink=0.5)
    plt.savefig('denoising/benchmarks/plots/roi_crop_sample_input.pdf',
                bbox_inches='tight', dpi=200)
    ax.set_title(r'DN input crop, ADC heatmap')
    plt.savefig('denoising/benchmarks/plots/dn_crop_sample_input.pdf',
                bbox_inches='tight', dpi=200)
    plt.close()
