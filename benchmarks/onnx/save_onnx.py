...
if __name__ == "__main__":
    ...
    parser.add_argument("--onnx", type=Path, help="the output onnx model filename", default="network.onnx")
    parser.add_argument("--batch_size", type=int, help="onnx model batch size", default=32)
    args = parser.parse_args()

    if args.modeltype == "uscg" and args.batch_size != 1:
        print(f"WARNING: uscg network accepts batch size equal to 1 only: found {args.batch_size}, skipping this")
